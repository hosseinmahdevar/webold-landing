...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "آژانس طراحی وب",
    "استودیو وبولد",
    "گروه نرم‌افزاری نوین پردازش اوراسیا",
    "نوین پردازش اوراسیا",
    "Webold",
    "طراحی UI/UX",
    "سئو فنی",
  ...
  authors: [{ name: "Webold (گروه نرم‌افزاری نوین پردازش اوراسیا)", url: siteConfig.url }],
  creator: "گروه نرم‌افزاری نوین پردازش اوراسیا (Webold)",
  openGraph: {
    type: "website",
    locale: "fa_IR",
    url: siteConfig.url,
